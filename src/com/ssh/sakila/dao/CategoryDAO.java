...
import com.ssh.sakila.pojo.Category;
 ...
 * 
 * @see com.ssh.sakila.pojo.Category
...
public class CategoryDAO {
	...
	public Category findById(java.lang.Short id) {
		...
		try {
			Category instance = (Category) getCurrentSession().get(
					"com.ssh.sakila.pojo.Category", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Category> findByExample(Category instance) {
		...
		try {
			List<Category> results = (List<Category>) getCurrentSession()
					.createCriteria("com.ssh.sakila.pojo.Category")
