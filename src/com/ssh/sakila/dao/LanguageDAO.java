...
import com.ssh.sakila.pojo.Language;
 ...
 * 
 * @see com.ssh.sakila.pojo.Language
...
public class LanguageDAO {
	...
	public Language findById(java.lang.Short id) {
		log.debug("getting Language instance with id: " + id);
		try {
			Language instance = (Language) getCurrentSession().get(
					"com.ssh.sakila.pojo.Language", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Language> findByExample(Language instance) {
		...
		try {
			List<Language> results = (List<Language>) getCurrentSession()
					.createCriteria("com.ssh.sakila.pojo.Language")
	...
	public Language merge(Language detachedInstance) {
		...
		try {
			Language result = (Language) getCurrentSession().merge(
					detachedInstance);
