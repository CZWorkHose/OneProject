...
import com.ssh.sakila.pojo.City;
	...
	public List<City> findByExample(City instance) {
		...
		try {
			List<City> results = (List<City>) getCurrentSession()
					.createCriteria("com.ssh.sakila.pojo.City")
