...
import com.ssh.sakila.pojo.Customer;
 ...
 * 
 * @see com.ssh.sakila.pojo.Customer
...
public class CustomerDAO {
	...
	public Customer findById(java.lang.Short id) {
		log.debug("getting Customer instance with id: " + id);
		try {
			Customer instance = (Customer) getCurrentSession().get(
					"com.ssh.sakila.pojo.Customer", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Customer> findByExample(Customer instance) {
		...
		try {
			List<Customer> results = (List<Customer>) getCurrentSession()
					.createCriteria("com.ssh.sakila.pojo.Customer")
